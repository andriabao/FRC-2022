...
public class Constants {
  ...
  // rot / m = 
  public static final double GEAR_RATIO = 1/7.44; // MotorCnt / WheelCnt;
  ...
  // public static final Gains SHOOTER_V_GAINS = new Gains(0.0004, 0, 0.0009, 0, 0, 12);
  ...
  public static final double MAX_SHOOT_RPM_ERROR = 60;
  ...
  public static final double INNER_MAX_SHOOT_DIS = 20;
